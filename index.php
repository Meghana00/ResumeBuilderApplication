...
<body>
  ...
  <div class="team" id="team" data-aos ="flip-up">
    <h4 class="mt-5 mb-5">OUR TEAM</h4>
  </div>
  <center>
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-md-auto"data-aos="zoom-in">
          <div class="image-area">
            <div class="img-wrapper">
              <img src="images\meghu.jpg" alt="MAGHANA">
              <h2>MEGHANA</h2>
              <h5>Team Leader</h5>
              <ul>
                <li><a href="https://github.com/Meghana00"><i class="fa fa-github"></i></a></li>
                <li><a href="https://www.instagram.com/ch.soujanya09/"><i class="fa fa-instagram"></i></a></li>
                <li><a href="https://www.linkedin.com/in/meghana-chirravooru-0323ab1b1"><i
                      class="fa fa-linkedin"></i></a></li>
                <li><a href="https://www.facebook.com/ch.soujanya.9"><i class="fa fa-facebook"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="row  justify-content-center" data-aos="fade-down">
        ...
        <div class="col-md-auto">
          <div class="image-area">
            <div class="img-wrapper">
              <img src="images\Bhargav1.jpg" alt="BHARGAV">
              <h2>BHARGAV</h2>
              <h5>Team Member</h5>
              <ul>
                <li><a href="https://github.com/Bhargava36"><i class="fa fa-github"></i></a></li>
                <li><a href="https://www.instagram.com/_bhargav_3677_/?hl=en"><i class="fa fa-instagram"></i></a></li>
                <li><a href="https://twitter.com/Bhargav__Arjun"><i class="fa fa-twitter"></i></a></li>
               
                <li><a href="https://www.linkedin.com/in/bhargava-naidu-jaddu-b60a6b214"><i
                      class="fa fa-linkedin"></i></a></li>
        ...
        <div class="col-md-auto">
          <div class="image-area">
            <div class="img-wrapper">
              <img src="images\Balaji.jpg" alt="BALAJI">
              <h2>balaji</h2>
              <h5>TEAM MEMBER</h5>
              <ul>
                <li><a href="https://www.linkedin.com/in/dadi-balaji-b07b35215"><i class="fa fa-linkedin"></i></a></li>
                <li><a href="https://instagram.com/balaji.dadi.37?utm_medium=copy_link"><i
                      class="fa fa-instagram"></i></a></li>
                <li><a href="https://twitter.com/balaji_dadi?s=09"><i class="fa fa-twitter"></i></a></li>
                <li><a href="https://youtube.com/channel/UCub9rWQBq7AosrTinayEm3Q"><i class="fa fa-youtube"></i></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-md-auto">
          <div class="image-area">
            <div class="img-wrapper">
              <img src="images\Kavya sri.jpg" alt="KAVYSRI">
              <h2>kavyasri</h2>
              <h5>TEAM MEMBER</h5>
              <ul>
                <li><a href="https://www.linkedin.com/in/bendi-kavya-sri-a75893214"><i class="fa fa-linkedin"></i></a>
                </li>
                <li><a href="https://instagram.com/kavyasribendi?utm_medium=copy_link"><i
                      class="fa fa-instagram"></i></a></li>
                <li><a href="https://twitter.com/atuljustano"><i class="fa fa-twitter"></i></a></li>
                <li><a href="https://www.youtube.com/channel/UCf-KfxuY8PZBSD_8RW2nYsw"><i class="fa fa-youtube"></i></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-md-auto">
          <div class="image-area">
            <div class="img-wrapper">
              <img src="images\Sowmya.jpg" alt="SOWMYA">
              <h2>Sowmya</h2>
              <h5>Team member</h5>
              <ul>
                <li><a href="https://Github.com/Sowmyapeddini"><i class="fa fa-github"></i></a></li>
                <li><a href="https://www.instagram.com/itz__chomu?utm_medium=copy_link"><i class="fa fa-instagram"></i></a></li>
      ...
      <div class="footer-content">
        <div class="footer-section about">
          ...
          <div class="contact">
            ...
            <i class="fa fa-envelope"> &nbsp; chirravoorumeghana@gmail.com</i>
          </div>
        ...
        <div class="footer-section contact-form-div">
          ...
          <br>
          <form action="https://formsubmit.co/bhargavanaidujaddu@gmail.com" method="post">
  ...
  <div class="container text-muted text-center py-3">
    <h5>
      Copyright &copy; 2021 |
      <a class="text-primary text-decoration-none" href="#about">Developer's club</a>
    </h5>
  </div>
        ...
        <div class="modal-body text-center text-dark">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <img class="img-fluid  rounded mb-5" width="60%"
                  src="images\Achievements.png" alt="" />
              </div>
              <div class="col-lg-8 text-dark">
                <h1>Personal Information Section</h1>
